    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .profile-section-nav {
            ...
            padding: 4px 12px; border-radius: 8px; text-decoration: none; transition: var(--transition);
        }
        ...
        .info-banner i { font-size: 1.8rem; color: var(--accent-blue); }
        .info-banner-content h4 { color: var(--primary-blue); font-size: 1.1rem; font-weight: 600; margin-bottom: 0.3rem; }
        .info-banner-content p { color: var(--dark-gray); margin: 0; font-size: 0.95rem; line-height: 1.5; }
        ...
        .action-btn {
            padding: 6px 12px; border-radius: 6px; text-decoration: none; font-size: 0.8rem; font-weight: 500; transition: var(--transition);
        ...
        .page-btn:disabled { background: var(--dark-gray); opacity: 0.6; cursor: not-allowed; transform: none; box-shadow: none; }
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        ...
        <div class="nav-links d-none d-lg-flex">
            ...
            <a href="{{ route('dean.syllabus') }}" class="active">
...
<div id="mobileSidebar" class="mobile-sidebar">
    ...
    <a href="{{ route('dean.research') }}" onclick="closeSidebar()"><i class="fas fa-microscope me-2"></i>Research</a>
    <a href="{{ route('dean.syllabus') }}" class="active" onclick="closeSidebar()"><i class="fas fa-book me-2"></i>Syllabus</a>
...
<div class="main-container">
    <div class="container">
        ...
        <div class="page-header">
            ...
            <p class="page-subtitle">View all faculty syllabus submissions</p>
        </div>
        ...
        <div class="info-banner">
            ...
            <div class="info-banner-content">
                ...
                <p>You have read-only access to the syllabus repository. All syllabus submissions are managed and reviewed by the evaluator before final approval.</p>
            </div>
        </div>

        <div class="action-bar">
            <div class="toggle-buttons">
                <button class="toggle-btn active" id="allBtn" onclick="showAllSyllabus()">
            ...
            <form class="search-form" action="{{ route('dean.syllabus') }}" method="GET">
                @php
                    $years = $syllabuses->pluck('academic_year')->filter()->unique()->sortDesc();
                @endphp
                ...
                <input type="text"
                       name="search"
                       class="search-input"
                       placeholder="Search syllabus submissions..."
                ...
                <select name="year"
                        id="yearFilter"
                        class="form-select"
                        style="padding: 12px 16px; border: 2px solid var(--primary-blue); border-radius: 25px; width: 200px;">
                ...
                <a href="{{ route('dean.syllabus', ['view' => request('view', 'all')]) }}" class="clear-btn" style="text-decoration:none;"><i class="fas fa-times me-1"></i>Clear</a>
            </form>
        </div>
        ...
        <div class="table-container">
            <div class="table-header">
                <h3 id="tableTitle">
                    <i class="fas fa-book me-2"></i>All Syllabus Submissions
                </h3>
            </div>
                    ...
                    <tbody id="syllabusTableBody">
                        @forelse ($syllabuses as $syllabus)
                            <tr class="syllabus-row"
                                ...
                                <td><span class="instructor-name">{{ $syllabus->instructor }}</span></td>
                                <td>
                                ...
                                <td>
                                    <div class="action-links">
                                        @if ($syllabus->status === 'Approved')
                                            <a href="{{ route('faculty.syllabus.view', $syllabus->id) }}" target="_blank" class="action-btn view">
                                                <i class="fas fa-eye"></i>View
                                            </a>
                                            <a href="{{ route('faculty.syllabus.download', $syllabus->id) }}" class="action-btn download">
                            ...
                            <tr id="emptyRow">
                                <td colspan="12">
                                    <div class="empty-state">
                                        ...
                                        <p id="emptyMessage">There are no syllabus submissions in the repository at this time.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
...
function clearSearch() {
    const currentViewValue = document.getElementById('searchView').value;
    window.location.href = "{{ route('dean.syllabus') }}?view=" + currentViewValue;
}
...
function showAllSyllabus() {
    ...
    document.getElementById('tableTitle').innerHTML = '<i class="fas fa-book me-2"></i>All Syllabus Submissions';
    currentPage = 1;
...
function showPendingSyllabus() {
    ...
    document.getElementById('tableTitle').innerHTML = '<i class="fas fa-clock me-2"></i>Pending Syllabus Submissions';
    currentPage = 1;
    applyFiltersAndPagination();
...
function showApprovedSyllabus() {
    ...
    document.getElementById('pendingBtn').classList.remove('active');
    document.getElementById('allBtn').classList.remove('active');
    document.getElementById('tableTitle').innerHTML = '<i class="fas fa-check-circle me-2"></i>Approved Syllabus Submissions';
    currentPage = 1;
    applyFiltersAndPagination();
...
function updateEmptyState(view) {
    ...
    if (view === 'approved') {
        emptyTitle.textContent = 'No Approved Syllabus Found';
        emptyMessage.textContent = 'There are no approved syllabus submissions at this time.';
    } else if (view === 'pending') {
        emptyTitle.textContent = 'No Pending Syllabus Found';
        emptyMessage.textContent = 'There are no pending syllabus submissions at this time.';
    } else {
        emptyTitle.textContent = 'No Syllabus Submissions Found';
        emptyMessage.textContent = 'There are no syllabus submissions in the repository at this time.';
    }
}
...
function applyFiltersAndPagination() {
    ...
    if (total > 0) {
        ...
        matching.slice(startIdx, startIdx + PAGE_SIZE).forEach(row => { row.style.display = ''; });
...
function updateEmptyRow(showEmpty) {
    ...
    if (showEmpty) {
        ...
        if (filtersActive) {
            if (titleEl) titleEl.textContent = 'No Syllabus Found';
            if (messageEl) messageEl.textContent = 'No syllabus submissions match your filters.';
        } else {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    initFlashAutoHide('flashError', 3000);
